	...
	var titleBar = {
		...
		cols:[		
			...
			click: function(){
				 ...
				 $$("dt_dwh_loadedData").parse(impobject.getImportData("importstock",PageIndex,$$('pagelen').getValue()));
			}},
...
//  			webix.message("done");
			...
			$$("dt_dwh_loadedData").clearAll();
			$$("dt_dwh_loadedData").parse(impobject.getImportData("importstock",1,200));
		}
	};
