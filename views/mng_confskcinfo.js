		...
		rows:[
			{
				...
				columns:[
					...
					{ id:"productcode",header:"款式", sort:"string",width:150},
					{ id:"colorname",header:"颜色", sort:"string",width:150},
					{ id:"yearname",header:"年份", sort:"string",width:150},
					{ id:"seasonname",header:"季节", sort:"string",width:150},
					{ id:"seasonstagename",header:"波段", sort:"string",width:150},
					{ id:"seriesname",header:"系列", sort:"string",width:150},
					{ id:"maintypename",header:"大类", sort:"string",width:150},
